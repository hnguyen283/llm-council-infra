...
set "PLAT_FILES=-f %PLAT_DIR%\docker-compose.yml -f %PLAT_DIR%\overlays\prod.yml -f %PLAT_DIR%\overlays\log-files.yml"

set "CORE_DIR=projects\core"
set "CORE_FILES=-f %CORE_DIR%\docker-compose.yml -f %CORE_DIR%\overlays\prod.yml -f %CORE_DIR%\overlays\log-files.yml"

set "GRAPHRAG_DIR=projects\graphrag"
set "GRAPHRAG_FILES=-f %GRAPHRAG_DIR%\docker-compose.yml"
...
for %%P in ("%DATA_FILES%" "%MESSAGING_FILES%" "%GRAPHRAG_FILES%" "%AI_FILES%" "%OBS_FILES%" "%PLAT_FILES%" "%CORE_FILES%") do (
